for i in 1 2 3 4; do
  ros2 param set --spin-time 2.0 /drone_manager${i} system_id_list "[1,2,3,4]"
  ros2 param set --spin-time 2.0 /drone_manager${i} system_id ${i}
  ...
  ros2 param set --spin-time 2.0 /drone_manager${i} formation_k_scale 2.0
  ...
  ros2 param set --spin-time 2.0 /drone_manager${i} weight_table "[0,1,1, 4,1,0, 4,1,2]"
  ros2 param set --spin-time 2.0 /drone_manager${i} num_particles 500
